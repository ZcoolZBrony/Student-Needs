    ...
    return (
      <View style={styles.container}>
        ...
        <InputField
          ...
          rightIcon={rightIcon}
        />
        <TouchableOpacity style={styles.BSIBtn} onPress={() => navigation.navigate('Signup')}>
          <View style={{flexDirection: "row"}}> 
            <Text style={styles.bsibuttonText}>Best Selling Items {"\n"}</Text>
              <Image 
                style={{width: 80, height: 80, marginLeft:80}} 
        ...
        <View style={{flexDirection:"row", justifyContent:"space-between"}}>
          ...
          <TouchableOpacity style={styles.catagoryBtn2} onPress={() => navigation.navigate('Signup')}>
            <View style={{flexDirection: "row",justifyContent:"center"}}>
              <Image 
                style={styles.catagoryimage} 
