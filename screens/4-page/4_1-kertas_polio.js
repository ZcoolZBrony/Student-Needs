...
export default function kertas_polio({ navigation }) {
        ...
        <View style={styles.containertext2}>
          ...
          <Text style={styles.baseText}>
            <Text style={{fontSize: 16}}>
              kertas yang dijual disini adalah kertas dengan kualitas terbaik, harga diatas adalah harga per 10 lembar
              {"\n"}
            </Text>
          </Text>
        </View>
