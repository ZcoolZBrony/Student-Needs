...
export default function paper_klip({ navigation }) {
        ...
        <View style={styles.containertext2}>
          ...
          <Text style={styles.baseText}>
            <Text style={{fontSize: 16}}>
              Paper klip yang dijual disini adalah paper klip dengan kualitas terbaik, harga diatas adalah harga termurah 
              {"\n"}
            </Text>
          </Text>
        </View>
