...
export default function pensil({ navigation }) {
        ...
        <View style={styles.containertext2}>
          ...
          <Text style={styles.baseText}>
            <Text style={{fontSize: 16}}>
              Pensil yang dijual adalah pensil yang dibuat dari bahan bahan terbaik dan diolah menggunakan teknologi terbarukan.
              {"\n"}
            </Text>
          </Text>
        </View>
