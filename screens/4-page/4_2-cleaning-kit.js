...
export default function cleaningkit({ navigation }) {
        ...
        <View style={styles.containertext2}>
          ...
          <Text style={styles.baseText}>
            <Text style={{fontSize: 16}}>
              Cleaning kit yang dijual disini adalah Cleaning kit dengan kualitas terbaik, harga dijamin paling murah tapi barang tidak murahan.
              {"\n"}
            </Text>
          </Text>
        </View>
