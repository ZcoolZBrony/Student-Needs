...
export default function flashdisk({ navigation }) {
        ...
        <View style={styles.containertext2}>
          ...
          <Text style={styles.baseText}>
            <Text style={{fontSize: 16}}>
              flashdisk yang dijual disini adalah flashdisk dengan kualitas terbaik. Dengan desain yang bergaya, ringkas dan kapasitas yang besar.
              {"\n"}
            </Text>
          </Text>
        </View>
