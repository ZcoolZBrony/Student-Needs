...
export default function multimeter({ navigation }) {
        ...
        <View style={styles.containertext2}>
          ...
          <Text style={styles.baseText}>
            <Text style={{fontSize: 16}}>
              Multimeter yang dijual adalah multimeter dengan kualitas terbaik dan terbaru. Multimeter ini ialah multimeter digital.
              {"\n"}
            </Text>
          </Text>
        </View>
