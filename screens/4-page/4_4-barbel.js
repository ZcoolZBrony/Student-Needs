...
export default function barbel({ navigation }) {
        ...
        <View style={styles.containertext2}>
          ...
          <Text style={styles.baseText}>
            <Text style={{fontSize: 16}}>
              Alat fitness klasik DUMBELL yang dapat digunakan kapan saja dan dimana saja. Gratis satu buah sarung tangan kebugaran.
              {"\n"}
            </Text>
          </Text>
        </View>
