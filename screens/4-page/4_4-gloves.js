...
export default function gloves({ navigation }) {
        ...
        <View style={styles.containertext2}>
          ...
          <Text style={styles.baseText}>
            <Text style={{fontSize: 16}}>
              Sarung tangan yang dijual adalah sarung tangan yang berkualitas. 100% original. 100% real pict. Free gantungan kunci
              {"\n"}
            </Text>
          </Text>
        </View>
