...
export default function matres({ navigation }) {
        ...
        <View style={styles.containertext2}>
          ...
          <Text style={styles.baseText}>
            <Text style={{fontSize: 16}}>
              Matras yang dijual adalah matras kualitas terbaik. Diformulasikan menggunakan bahan yang tidak licin. Harga pas kualitas tidak murahan.
              {"\n"}
            </Text>
          </Text>
        </View>
