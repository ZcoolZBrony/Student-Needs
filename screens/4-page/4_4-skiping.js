...
export default function skiping({ navigation }) {
        ...
        <View style={styles.containertext2}>
          ...
          <Text style={styles.baseText}>
            <Text style={{fontSize: 16}}>
              skiping yang dijual adalah skiping dengan kualitas terbaik dan terbaru. Harga termurah tapi barang tidak murahan.
              {"\n"}
            </Text>
          </Text>
        </View>
