...
export default function Sock({ navigation }) {
        ...
        <View style={styles.containertext2}>
          ...
          <Text style={styles.baseText}>
            <Text style={{fontSize: 16}}>
              Kaos kaki yang dijual adalah kaos kaki dengan kualitas terbaik dan terbaru. Harga murah tapi kualitas tidak murahan
              {"\n"}
            </Text>
          </Text>
        </View>
